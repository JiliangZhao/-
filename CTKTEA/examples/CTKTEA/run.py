...
from TransformNet.algos.ppo.ppo import transformnet_ppo
from evogym import sample_robot, hashable
import utils.mp_group as mp
from utils.algo_utils import get_percent_survival_evals, mutate, TerminationCondition, Structure

def run_ctktea(experiment_name, structure_shape, pop_size, max_evaluations, train_iters, num_cores, env_name):
    print()
    ...
    while True:
        ...
        for structure in structures:
            ...
            if structure.is_survivor:
                ...
                group.add_job(transformnet_ppo, ppo_args, callback=structure.set_reward)
